...
## Given a shift number, for each player on the ice for the offensive team for this shift, 
## this function returns the distribution of their contribution to their team's shots  
## relative to the median player. So the returned object is a 4,000 by 5 matrix. 
## Actually, to facilitate the calculation of the running total across all the shifts in the season
## in the for loop that follows, it will return a list whose first element is the aforementioned matrix 
